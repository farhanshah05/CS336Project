...
<body>
	...
	<form method="POST" action="SaveTrainLine.jsp">
		<label for="lineName">Line Name:</label> <input type="text"
			id="lineName" name="lineName" required><br> <br> <label
			for="trainID">Select Train:</label> <select id="trainID"
			name="trainID" required>
			<%
