	...
	try {
		...
		try {
			...
			PreparedStatement stmt = con
					.prepareStatement("UPDATE TrainStops SET ArrivalTime = ?, DepartureTime = ? WHERE StopID = ?");
		...
		if (hasError) {
			...
			out.println("<h2>Invalid input. Please try again. <a href='EditSchedule.jsp?scheduleID=" + scheduleID
			+ "'>Go back</a></h2>");
		} else {
