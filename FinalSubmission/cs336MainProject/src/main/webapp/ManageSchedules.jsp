...
<body>
	...
	<table border="1">
		...
		try (Statement stmt = con.createStatement()) {
			ResultSet rs = stmt.executeQuery("SELECT ts.ScheduleID, t.LineName, ts.Departure, ts.Arrival "
			+ "FROM TrainSchedules ts " + "JOIN TransitLines t ON ts.LineID = t.LineID");
