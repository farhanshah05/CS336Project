...
<body>
    ...
    <%
        ...
        try {
            ...
            pstmt = con.prepareStatement("INSERT INTO Conversations (CustomerID, EmployeeID, Status) VALUES (?, ?, 'open')", Statement.RETURN_GENERATED_KEYS);
            ...
            pstmt = con.prepareStatement("INSERT INTO Messages (ConversationID, SenderID, ReceiverID, Message) VALUES (?, ?, ?, ?)");
